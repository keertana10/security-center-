...
/* harmony import */ var _app_auth_auth_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../app/auth/auth.component */ "./src/app/auth/auth.component.ts");
...
/* harmony import */ var _app_dashboard_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../app/dashboard/dashboard/dashboard.component */ "./src/app/dashboard/dashboard/dashboard.component.ts");
...
/* harmony import */ var _app_oauthSettings__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../app/oauthSettings */ "./src/app/oauthSettings.ts");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _app_auth_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../app/auth.service */ "./src/app/auth.service.ts");
...
let AppComponent = class AppComponent {
    ...
    //   ],
    // };
    constructor(broadcastService, authService, http, access) {
    ...
    login() {
        ...
        console.log(isIE);
        if (!isIE) {
            this.authService.loginPopup(_app_oauthSettings__WEBPACK_IMPORTED_MODULE_4__["OAuthSettings"]);
    ...
    // }
    token() {
        const name = { name: 'Manikandan' };
        this.http.get('http://localhost:3000/api/post').subscribe(response => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "protectedResourceMaps", function() { return protectedResourceMaps; });
...
/* harmony import */ var _app_dashboard_dashboard_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../app/dashboard/dashboard.module */ "./src/app/dashboard/dashboard.module.ts");
/* harmony import */ var _azure_msal_angular__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @azure/msal-angular */ "./node_modules/@azure/msal-angular/fesm2015/azure-msal-angular.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _auth_interceptor__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./auth-interceptor */ "./src/app/auth-interceptor.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        ...
        imports: [
            _app_dashboard_dashboard_module__WEBPACK_IMPORTED_MODULE_9__["DashboardModule"],
...
let AuthInterceptor = class AuthInterceptor {
    ...
    intercept(req, next) {
        ...
        //   });
        const authToken = localStorage.getItem('AccessTokenForAPI');
...
/* harmony import */ var _azure_msal_angular__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @azure/msal-angular */ "./node_modules/@azure/msal-angular/fesm2015/azure-msal-angular.js");
/* harmony import */ var _app_services_alerts_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../app/services/alerts.service */ "./src/app/services/alerts.service.ts");
...
let AuthService = class AuthService {
    constructor(authService, http, alertService) {
        this.authService = authService;
        this.http = http;
    ...
    getAccessToken() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            // tslint:disable-next-line: prefer-const
            let result = yield this.authService.acquireTokenSilent(this.requestObj)
                .catch((reason) => {
                console.log(reason);
            });
            if (result) {
    ...
    getAccessTokenFromBackend() {
        this.http.get('http://localhost:3001/api/token').subscribe(data => {
            console.log(data);
            console.log(data.accessToken);
            this.accessTOken2 = data.accessToken;
            localStorage.setItem('AccessTokenForAPI', data.accessToken);
            // this.alertService.getUserDetails();
        });
    }
    logout() {
        this.authService.logout();
    ...
    getAlerts() {
        // this.http.get('http://localhost:3001/api/alert').subscribe(data => {
        //   console.log(data);
        // });
    }
};
...
let AuthComponent = class AuthComponent {
    constructor(broadcastService, authService, http, access, router) {
        this.broadcastService = broadcastService;
        this.authService = authService;
        this.http = http;
        this.access = access;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DashboardAlertsComponent", function() { return DashboardAlertsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm2015/material.js");
/* harmony import */ var _services_alerts_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/alerts.service */ "./src/app/services/alerts.service.ts");





let DashboardAlertsComponent = class DashboardAlertsComponent {
    ...
    ngOnInit() {
        ...
        this.alertService.getUpdatedAlerts().subscribe(response => {
            console.log(response.result.value);
            this.alerts = response.result.value;
            this.alertData = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](this.alerts);
            this.alertData.sort = this.sort;
            this.alertData.paginator = this.paginator;
        });
    }
    ...
    manageAlerts(alertsId, templateRef) {
...
DashboardAlertsComponent.ctorParameters = () => [
...
DashboardAlertsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-dashboard-alerts',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./dashboard-alerts.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/dashboard-alerts/dashboard-alerts.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./dashboard-alerts.component.css */ "./src/app/dashboard/dashboard-alerts/dashboard-alerts.component.css")).default]
    })
...
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm2015/material.js");
/* harmony import */ var _dashboard_alerts_dashboard_alerts_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./dashboard-alerts/dashboard-alerts.component */ "./src/app/dashboard/dashboard-alerts/dashboard-alerts.component.ts");
...
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm2015/material.js");
/* harmony import */ var _services_alerts_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/alerts.service */ "./src/app/services/alerts.service.ts");
/* harmony import */ var _dashboard_alerts_dashboard_alerts_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../dashboard-alerts/dashboard-alerts.component */ "./src/app/dashboard/dashboard-alerts/dashboard-alerts.component.ts");
...
let DashboardComponent = class DashboardComponent {
    ...
    openAlerts2() {
        const dialogRef = this.dialog.open(_dashboard_alerts_dashboard_alerts_component__WEBPACK_IMPORTED_MODULE_4__["DashboardAlertsComponent"], {
            width: '1200px',
            height: '700px'
            // data: { name: this.name, animal: this.animal }
        });
...
DashboardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./dashboard.component.css */ "./src/app/dashboard/dashboard/dashboard.component.css")).default]
    })
], DashboardComponent);
...
let NavBarComponent = class NavBarComponent {
    constructor(broadcastService, authService, http, access, dialog) {
        this.broadcastService = broadcastService;
        this.authService = authService;
        this.http = http;
        this.access = access;
    ...
    checkoutAccount() {
        ...
        this.loggedIn = !!this.authService.getAccount();
        console.log(this.loggedIn);
        // if (localStorage.getItem('AccessTokenForAPI') !== null) {
        this.access.getAccessTokenFromBackend();
        // }
    }
    logout() {
...
let ProfileComponent = class ProfileComponent {
    constructor(authService, http, access) {
        this.authService = authService;
        this.http = http;
        this.access = access;
    }
...
module.exports = __webpack_require__(/*! F:\graph\security center\angular8-sample-app\src\main.ts */"./src/main.ts");
